<div class="col-sm-2">
    ...
    @foreach($articles as $article)
        <p><a href='news/{{ $article->article_url }}' class='label label-default'>{{ $article->created_at->format('d.m.Y') }}</a></p>
        ...
        <div class='row news--devider'>
            <div class='col-sm-11 news--devider--img' style='background-image: url({{ asset('images/orange_line_bg.gif') }});'>
                <p>&nbsp;</p>
            </div>
        </div>
    @endforeach
