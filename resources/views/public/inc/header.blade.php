<div class="row">
    ...
    <div class="col-sm-6 col-xs-12 header--menu" style="text-align:right;">
        <div class="header_social-area">
            <a class="header_social-link telegram" href="https://t.me/Alekstct" target="_blank">
                <svg class="header_social-img telegram-img" enable-background="new 0 0 24 24" height="512" viewBox="0 0 24 24" width="512" xmlns="http://www.w3.org/2000/svg">
            ...
            <a class="header_social-link whatsapp" href="https://wa.me/79135396539" target="_blank">
                <svg class="header_social-img whatsapp-img" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
